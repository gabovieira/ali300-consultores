...
import { ClipboardList, CheckCircle, UserPlus, LogIn, ArrowRight } from 'lucide-react';
...
const WelcomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        ...
        <div className="container mx-auto flex justify-between items-center px-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center transition-transform hover:scale-105">
              <img src="/logo.png" alt="Logo ALI 3000" className="w-24 h-24" onError={(e) => (e.currentTarget.src = 'https://via.placeholder.com/96')} />
            </div>
          </div>
          ...
          {/* Botones de inicio de sesión y registro como iconos */}
      ...
      {/* Hero Section */}
      <section id="inicio" className="pt-44 pb-28 px-6 relative">
        ...
        <div className="container mx-auto text-center relative z-20 mt-8">
          <div className="animate-fadeIn opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            <p className="text-lg text-cyan-400 mb-10 max-w-2xl mx-auto">
              Formando consultores de excelencia a través de nuestro Taller de Formación para el Trabajo
            </p>
            <div className="flex justify-center gap-4">
              <button
                onClick={handleRegister}
                className="bg-cyan-600 hover:bg-cyan-700 text-white px-8 py-3 rounded-lg text-lg font-medium flex items-center gap-2 transition-all hover:translate-y-[-5px] hover:shadow-lg"
              >
                Comenzar ahora
      ...
      {/* Features */}
      <section id="caracteristicas" className="py-16 px-6 bg-gray-800 bg-opacity-50">
        <div className="container mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12 animate-slide-in">Características principales</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Características con efectos de animación al hacer scroll */}
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="ListTodo" className="text-cyan-300 w-8 h-8" />
              </div>
              <h4 className="text-xl font-semibold mb-3">Gestión de Requerimientos</h4>
            ...
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="CheckCircle" className="text-cyan-300 w-8 h-8" />
              </div>
              <h4 className="text-xl font-semibold mb-3">Seguimiento de Tareas</h4>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="Clock" className="text-cyan-300 w-8 h-8" />
              </div>
              <h4 className="text-xl font-semibold mb-3">Control de Tiempo</h4>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="BarChart3" className="text-cyan-300 w-8 h-8" />
              </div>
              <h4 className="text-xl font-semibold mb-3">Métricas y Estadísticas</h4>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="Users" className="text-cyan-300 w-8 h-8" />
              </div>
              <h4 className="text-xl font-semibold mb-3">Multiusuario</h4>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-750 rounded-lg p-6 shadow-lg flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="bg-cyan-900 p-3 rounded-full mb-4">
                <Icon name="LogIn" className="text-cyan-300 w-8 h-8" />
              </div>
